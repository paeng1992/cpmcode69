    ...
    while True:
        ...
        if login_response != 0:
            if login_response == 100:
                ...
                console.print("[bold red]TRY AGAIN (âœ˜)[/bold red].")
        ...
        while True:
            ...
            if service == 0: # Exit
                console.print(f"[bold yellow][!] Thank You for using our tool, please join our telegram channel[/bold yellow]: [bold blue]@{base64.b64decode("Q1BNTnVrZXJPZmZpY2lhbA==}[/bold blue].")
